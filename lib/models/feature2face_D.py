...
class Feature2Face_D(nn.Module):
    def __init__(self, cfg):
        ...
        self.netD = MultiscaleDiscriminator(13 + 3, cfg.ndf, cfg.n_layers_D, cfg.num_D, cfg.no_ganFeat)
...
class MultiscaleDiscriminator(nn.Module):
    def __init__(self, input_nc, ndf=64, n_layers=3, num_D=3, getIntermFeat=False):
